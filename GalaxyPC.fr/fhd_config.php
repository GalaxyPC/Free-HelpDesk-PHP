...
define('FROM_EMAIL','contact@galaxypc.fr');

/** email address to send new ticket and registration notices TO, etc  */
define('TO_EMAIL','contact@galaxypc.fr');
